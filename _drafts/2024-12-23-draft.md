...
Using MicroPython with an ESP32-based Cheap Yellow Display Board (CYD) - [Randomm Nerd Tutorials](https://randomnerdtutorials.com/micropython-cheap-yellow-display-board-cyd-esp32-2432s028r/).
