...
Welcome to the latest Python on Microcontrollers newsletter! This issue will wrap 2024 for the newsletter and things are at an all-time high. A summary of things is the headline. Next are two ways in which hardware is helping make software faster. And there has not been any lull in projects and news this week, check it all out below and Happy Holidays! The newsletter will resume in 2025 with the January 13th issue. - *Anne Barela, Editor*
