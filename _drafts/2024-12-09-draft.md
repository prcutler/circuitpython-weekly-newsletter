...
Jeff Epler at Adafruit has the code workinng and is integrating it into libraries for community use.
...
Open Source Security Priorities Get a Reshufflet - [DarkReading](https://www.darkreading.com/application-security/critical-open-source-rankings-shuffle-popularity-python-cloud-grows).
