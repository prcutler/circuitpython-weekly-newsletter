...
[![Deep Dive](../assets/20241125/20241125deepdive.jpg)](link)
...
[![title](../assets/20241125/20241125potw.jpg)](url)

text - [site](url).

## Popular Last Week

[![Popular Last Week](../assets/20241125/20241125last.jpg)](url)
...
[![title](../assets/20241125/20241125play1.jpg)](url)
...
[![title](../assets/20241125/20241125play3.jpg)](url)
...
[![title](../assets/20241125/20241125new1.jpg)](url)

text - [site](url).

[![title](../assets/20241125/20241125new2.jpg)](url)
...
[![Dan](../assets/20241125/20241125dan.jpg)](https://www.circuitpython.org/)

text.

**Tim**

I am continuing to work on issues across the CircuitPython libraries and resolved a handful more this week. One that I'm particularly stoked about is a new `FilledPolygon` for `Display_Shapes`, as well as support for stroke size for bot it and the pre-existing `Polygon` classes. I also added some logic to the circuitpython.org search function to give higher precedent to devices with tags that match search terms exactly. This resolves an issue that caused the Pico 2 device to be somewhat far down the page if you searched "Pico 2". Today I've started on a new project to fetch posts from Bluesky and show them on a display.
...
[![Scott](../assets/20241125/20241125scott.jpg)](https://www.circuitpython.org/)
